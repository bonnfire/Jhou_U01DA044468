...
full_join(jhou_r_sessions_runway, runway_latency_c01_16_7_df %>% 
  ...
  select(labanimalid, "filename" = file_jhou, run_latency_raw_jhou_round, "latency_raw_bonnie" = latency, start_latency_raw_jhou, "location_2_bonnie" = secondbeam, goal_latency_raw_jhou, "reached_bonnie" = reachedgoal) %>% 
